  ...
  return (
    <section className="py-16 md:py-24">
      <div className="container">
        <div className="relative rounded-[20px] bg-[url('https://mediumslateblue-salamander-253615.hostingersite.com/wp-content/uploads/2025/07/LAst_CTA_1617_1696.png')] bg-cover bg-center p-8 md:p-16 text-center text-white overflow-hidden">
          {/* The dark overlay was removed to match the bright center of the original image */}
          <div className="relative z-10 flex flex-col items-center gap-8">
            <div className="flex flex-col items-center gap-2">
              ...
              {/* Updated font size to text-xl and removed redundant margin to match Figma specs */}
              <p className="text-xl font-lato max-w-4xl opacity-90 leading-relaxed">
            ...
            {/* Updated button styles for border-radius and border color to match Figma */}
            <Button
              asChild
