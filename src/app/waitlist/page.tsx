...
export default function WaitlistPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-[#021637]">
      <section className="relative flex min-h-[660px] flex-col overflow-hidden bg-[#021637] sm:min-h-[690px] lg:min-h-[780px]">
        <div
          aria-hidden="true"
        ...
        <header className="relative z-10">
          <div className="mx-auto flex h-20 w-full max-w-[1180px] items-center justify-between px-5 sm:px-8 lg:h-[92px] lg:px-12">
            <Logo className="scale-[0.9] sm:scale-100 lg:scale-110" textClassName="text-white" />
            <a
              className="inline-flex h-10 items-center justify-center rounded-[4px] bg-[#fdaa2f] px-5 text-sm font-bold leading-none tracking-normal text-[#021637] transition hover:bg-[#ffbc58] sm:h-11 sm:px-6 lg:h-12 lg:px-7 lg:text-base"
              href="#waitlist-form"
            >
              Join Waitlist
            </a>
        ...
        <div className="relative z-10 mx-auto flex w-full max-w-[1180px] flex-1 items-center px-5 pb-14 pt-8 sm:px-8 sm:pb-20 lg:pb-28 lg:px-12">
          <div className="w-full max-w-[760px]">
            ...
            <h1 className="mt-6 max-w-[720px] text-[35px] font-extrabold leading-[1.12] tracking-normal text-white sm:text-[46px] lg:text-[62px]">
              Revolutionizing Football Scouting with{" "}
              <span className="text-[#ffddb7]">Data &amp; Insights</span>
            </h1>

            <p className="mt-5 max-w-[620px] text-base leading-7 text-white/80 sm:text-lg lg:text-[20px] lg:leading-8">
            ...
            <form
              className="mt-8 w-full max-w-[520px] lg:mt-10 lg:max-w-[560px]"
              id="waitlist-form"
            ...
            >
              <div className="rounded-[6px] bg-white p-1.5 shadow-[0_20px_60px_rgba(2,22,55,0.2)] sm:flex sm:items-center sm:gap-2 lg:p-2">
                ...
                <input
                  ...
                  autoComplete="off"
                  className="h-12 w-full rounded-[4px] border border-transparent bg-white px-4 text-sm text-[#1b1b1b] outline-none transition placeholder:text-[#44474e] focus:border-[#192b4d] focus:ring-2 focus:ring-[#192b4d]/10 sm:flex-1 lg:h-14 lg:px-5 lg:text-base"
                  id="waitlist-email"
                  inputMode="email"
                  name="EMAIL"
                ...
                <Button
                  className="mt-2 h-12 w-full rounded-[4px] bg-[#021637] px-5 text-sm font-bold leading-tight text-white hover:bg-[#192b4d] sm:mt-0 sm:w-[145px] lg:h-14 lg:w-[170px] lg:text-base"
              ...
              <p
                className="mt-4 flex items-center gap-2 text-[12px] font-bold leading-5 text-white/65 lg:mt-5 lg:text-[13px]"
                id="waitlist-note"
              >
      ...
      <section className="bg-white px-5 py-20 sm:px-8 lg:px-12 lg:py-28">
        <div className="mx-auto max-w-[1180px]">
          <div className="grid gap-10 lg:grid-cols-[1fr_auto] lg:items-end">
            <div>
              <h2 className="max-w-[620px] text-[30px] font-bold leading-[1.12] tracking-normal text-[#021637] sm:text-[36px] lg:text-[44px]">
                Game-Changing Tools for Next-Level Scouting
              </h2>
              <p className="mt-4 max-w-[640px] text-base leading-7 text-[#747880] lg:text-[18px] lg:leading-8">
          ...
          <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:mt-16 lg:grid-cols-3 lg:gap-8">
            {features.map((feature) => {
              ...
              return (
                <article
                  className={`min-h-[245px] rounded-[6px] border p-7 lg:min-h-[290px] lg:p-8 ${
                    feature.highlighted
                ...
                >
                  <div
                    className={`flex h-12 w-12 items-center justify-center rounded-md lg:h-14 lg:w-14 ${feature.iconClassName}`}
                  >
                    <Icon aria-hidden="true" className="h-6 w-6 lg:h-7 lg:w-7" />
                  </div>

                  <h3 className="mt-8 text-[22px] font-bold leading-tight tracking-normal lg:mt-10 lg:text-[24px]">
                    {feature.title}
                  </h3>
                  <p
                    className={`mt-4 text-base leading-7 lg:text-[17px] lg:leading-8 ${
      ...
      <section className="relative flex min-h-[300px] items-center overflow-hidden bg-[#021637] px-5 py-20 text-center text-white sm:px-8 lg:min-h-[380px] lg:px-12 lg:py-28">
        <div
          aria-hidden="true"
        ...
        />
        <div className="relative z-10 mx-auto max-w-[760px] lg:max-w-[860px]">
          <h2 className="text-[30px] font-extrabold leading-tight tracking-normal sm:text-[36px] lg:text-[44px]">
            Connecting Players, Coaches &amp; Scouts
          </h2>
          <p className="mx-auto mt-5 max-w-[650px] text-base leading-7 text-white/78 sm:text-lg lg:mt-6 lg:max-w-[760px] lg:text-[18px] lg:leading-8">
