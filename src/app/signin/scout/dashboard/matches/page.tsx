    ...
    <div className="p-3 md:p-6 min-h-screen">
      ...
      <div className="flex flex-col lg:flex-row gap-4 md:gap-6 max-w-7xl mx-auto">
        ...
        <div className="flex-1 lg:max-w-2xl">
          {/* Main Match Card */}
          <div className="relative w-full h-32 sm:h-40 md:h-48 lg:h-38 -mt-3 -ml-3 md:-mt-7 md:-ml-7">
            {/* Background Image */}
            <div 
            ...
            {/* Content Container */}
            <div className="absolute top-3 md:top-5 left-0 w-3/5 sm:w-2/5 h-16 sm:h-20 flex flex-col gap-2 md:gap-3">
              {/* Match Title */}
              <div className="px-3 md:px-5">
                <h2 
                  className="text-white text-sm md:text-base font-semibold leading-tight"
              ...
              <div className="pl-3 md:pl-5 flex flex-col gap-0.5">
                {/* Date Section */}
                <div className="flex items-center gap-1 md:gap-2 py-0.5">
                  <div className="w-3 h-3 md:w-[14px] md:h-[14px] opacity-92 flex items-center justify-center">
                    <svg width="12" height="13" viewBox="0 0 12 13" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-2 h-2 md:w-3 md:h-3">
                  ...
                  <span 
                    className="text-white text-xs md:text-xs font-normal leading-none"
                    style={{ fontFamily: 'Lato' }}
                  >
                    10 September, 2024
                  </span>
                ...
                {/* Venue Section */}
                <div className="flex items-center gap-1 md:gap-2 py-0.5">
                  <div className="w-3 h-3 md:w-[14px] md:h-[14px] opacity-84 flex items-center justify-center">
                    <svg width="12" height="10" viewBox="0 0 12 10" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-2 h-2 md:w-3 md:h-3">
                  ...
                  <span 
                    className="text-white text-xs md:text-xs font-normal leading-none opacity-92"
                    style={{ fontFamily: 'Lato' }}
                  >
            ...
            {/* Preview Button */}
            <button 
              className="absolute bottom-3 md:bottom-[18px] left-4 md:left-[22px] px-3 md:px-[14px] py-1.5 md:py-[6px] rounded-xl text-white text-xs font-medium leading-none text-center shadow-lg"
              style={{
                fontFamily: 'Lato',
            ...
            {/* Right Side Image */}
            <div 
              className="absolute top-0 right-0 w-2/5 sm:w-3/5 h-full rounded-r-xl bg-cover bg-center"
              style={{
          ...
          {/* Recent Matches Sections */}
          {Array.from({ length: 2 }).map((_, sectionIndex) => (
            <div key={sectionIndex} className="w-full mt-4 md:mt-6 -ml-3 md:-ml-7 bg-white rounded-xl p-3 shadow-lg">
              {/* Header Section */}
              <div className="mb-4">
                {/* Title */}
                <div className="mb-3">
                  <h3 className="text-black font-bold text-base pl-3 md:pl-5" style={{ fontFamily: 'Lato' }}>
                    Recent Matches
                  </h3>
                </div>
                
                {/* Tournament Info and View All on same line */}
                <div className="flex justify-between items-center pl-3 md:pl-5 pr-3 md:pr-5">
                  <div className="flex items-center gap-1">
                    <div className="w-8 h-8 md:w-9 md:h-9 border border-[#B1D4E0] rounded bg-gray-100"></div>
              ...
              <div className="opacity-88">
                {Array.from({ length: 7 }).map((_, index) => (
                  <div key={index} className="flex items-center justify-between px-3 md:px-5 py-2 border-b border-[#E0E0E0] bg-white">
                    {/* Left side - Status */}
                    <div className="flex items-center gap-2 md:gap-3">
                      <div className="w-4 h-4 md:w-[18px] md:h-[18px] flex items-center justify-center">
                        <svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-3 h-3 md:w-[14px] md:h-[13px]">
                      ...
                      <span className="text-[#555555] font-normal text-sm" style={{ fontFamily: 'Lato' }}>
                        {(index === 6 && sectionIndex === 0) || sectionIndex === 1 ? 'NS' : 'FT'}
                      </span>
                    </div>
                    
                    {/* Teams and Score - Responsive Layout */}
                    <div className="flex items-center gap-2 sm:gap-4 lg:gap-12 flex-1 justify-end">
                      {/* Team 1 */}
                      <div className="flex items-center gap-1">
                        <img 
                          src="https://images.unsplash.com/photo-1614632537190-23e4b20ced2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&h=100&q=80"
                          alt="Michaels Academy Logo"
                          className="w-4 h-4 md:w-[18px] md:h-[18px] rounded-full object-cover"
                        />
                        <span className="text-[#222222] font-normal text-xs md:text-sm hidden sm:block" style={{ fontFamily: 'Lato' }}>
                          Michaels Academy
                        </span>
                        <span className="text-[#222222] font-normal text-xs sm:hidden" style={{ fontFamily: 'Lato' }}>
                          Michaels
                        </span>
                      </div>
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <img 
                          src="https://images.unsplash.com/photo-1609952001917-1f252d4c2c71?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&h=100&q=80"
                          alt="St Johns Academy Logo"
                          className="w-4 h-4 md:w-[18px] md:h-[18px] rounded-full object-cover"
                        />
                      </div>
                    </div>
        ...
        {/* Right Column */}
        <div className="flex-1 lg:max-w-lg -mt-3 md:-mt-7">
          {/* Latest Article Section */}
          <div className="w-full h-auto bg-white rounded-xl shadow-lg">
            <div className="p-3 md:p-5 flex flex-col gap-4 md:gap-6">
              {/* Header */}
              <h3 className="text-[#222222] font-bold text-base pl-3 md:pl-5" style={{ fontFamily: 'Lato' }}>
                Latest Article
              </h3>
              
              {/* Articles List */}
              <div className="pl-3 md:pl-5 flex flex-col gap-3 md:gap-4">
                  ...
                  <div key={index} className="flex gap-3 md:gap-4">
                    ...
                    <img 
                      src={`https://images.unsplash.com/photo-${[
                        ...
                        '1606107557808-bb3c04f19e82',
                        '1574704266785-75e39b3e0f6e',
                        '1544948503-4e0b1c87e21d'
                      ][index]}?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&h=150&q=80`}
                      alt={`Article ${index + 1}`}
                      className="w-16 h-12 md:w-[79px] md:h-[60px] rounded object-cover flex-shrink-0"
                    />
          ...
          <div className="w-full h-auto bg-white rounded-xl shadow-lg mt-4 md:mt-6" style={{boxShadow: '0px 4px 12px 0px #0000001A'}}>
            <div className="pt-4 md:pt-[21px] pb-4 md:pb-[21px] px-0 flex flex-col gap-4 md:gap-6">
              {/* Header */}
              ...
              <div className="flex flex-col gap-2">
                {Array.from({ length: 4 }).map((_, index) => (
                  <div 
                    key={index}
                    className="flex flex-col sm:flex-row sm:items-center px-3 md:px-5 py-2 border-b border-[#E0E0E0] gap-3 sm:gap-0"
                    style={{borderBottomWidth: '0.32px'}}
                  >
                    {/* Avatar and Player Info Container */}
                      ...
                      <div className="flex-shrink-0">
                        <img
                          src={`https://images.unsplash.com/photo-${[
                            ...
                            '1500648767791-c0a3c6034c28',
                            '1472099645785-5658abf4ff4e',
                            '1519085360753-af0119f7c2b6'
                          ][index]}?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&h=150&q=80`}
                          alt={`Player ${index + 1}`}
                          className="rounded border-[#55555585] object-cover"
                          style={{width: '50px', height: '50px', borderWidth: '0.24px', borderRadius: '4px'}}
                        />
                      </div>

                      {/* Player Info */}
                      <div className="w-20 md:w-[92px] flex flex-col gap-1.5">
                    ...
                    {/* Metrics and Rating Container */}
                    <div className="flex flex-col sm:flex-row gap-3 sm:gap-6 sm:ml-auto">
                      {/* Metrics */}
                      <div className="flex gap-2 sm:gap-2" style={{opacity: 0.88}}>
                        {['Fitness', 'Technical', 'Tactical', 'Mental'].map((category, metricIndex) => (
                          <div key={metricIndex} className="flex flex-col gap-1" style={{width: '30px', fontSize: '7px'}}>
                            <div className="text-[#222222] font-medium leading-none" style={{ fontFamily: 'Lato' }}>
                              {category}
                            </div>
                            <div className="text-[#222222] font-medium" style={{ fontFamily: 'Lato', fontSize: '12px', lineHeight: '13px' }}>
                              00%
                            </div>
                            <div className="text-[#555555] font-medium leading-none" style={{ fontFamily: 'Lato' }}>
                              Improved
                            </div>
                          </div>
                        ))}
                      ...
                      <div className="flex items-center gap-2">
                        {/* Circular Progress */}
                        <div className="relative" style={{width: '38px', height: '38px'}}>
                          <svg width="38" height="38" viewBox="0 0 46 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <div className="absolute inset-0 flex items-center justify-center">
                            <span className="text-[#222222] font-normal" style={{ fontFamily: 'Lato', fontSize: '8px', lineHeight: '10px' }}>
                              0.0
                            </span>
                          </div>
                        </div>
                        ...
                        {/* Trophy Icon */}
                        <div className="w-6 h-6 md:w-8 md:h-8 bg-[#FFA500] rounded-full flex items-center justify-center p-1.5 md:p-2">
                          <svg width="19" height="16" viewBox="0 0 19 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-3 h-3 md:w-4 md:h-4">
