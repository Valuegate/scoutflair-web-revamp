...
export default function AcademyDetails() {
  ...
  const [academyInfo, setAcademyInfo] = useState([
    { blueLabel: "Academy Name", blueValue: "National Stadium", whiteLabel: "State", whiteValue: "Kaduna" },
    { blueLabel: "Phone", blueValue: "+234 812 345 6789", whiteLabel: "Email", whiteValue: "academy@email.com" },
    { blueLabel: "Website", blueValue: "www.academy.com", whiteLabel: "Founded", whiteValue: "2010" },
    { blueLabel: "Coach", blueValue: "John Doe", whiteLabel: "Players", whiteValue: "120" },
  ]);
  ...
  >
    ...
    >
      ...
      <div className="w-full max-w-2xl flex justify-between  items-center mb-12">
        <h1 className="text-lg font-bold text-[#0C1017BF]">Academy Details</h1>
        <span
