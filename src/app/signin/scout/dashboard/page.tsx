...
import ScoutingPlanWidget from "../components/scoutingPlanWidget";
      ...
      <div className="relative z-10 flex flex-col md:flex-row gap-4 items-start md:items-center justify-between">
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-[10px] sm:text-xs font-bold tracking-wider text-blue-200 uppercase">
              AI Daily Briefing
            </span>
          </div>
          <h2 className="text-lg sm:text-xl font-bold mb-2">
            Priority: Winger Mandate Expiring
          </h2>
          <p className="text-blue-100 text-xs sm:text-sm max-w-2xl leading-relaxed">
            Coach Dave's request for a "Left Winger" expires in 3 days. AI has
            identified{" "}
            <span className="font-bold text-white">3 potential matches</span>{" "}
            playing at Onikan Stadium this Saturday.
          </p>
        </div>
