...
const UKFlag = () => (
  <svg viewBox="0 0 20 15" className="w-8 h-4 inline-block rounded-md ml-2"> {/* ml-2 shifts right */}
...
export default function Topbar() {
  return (
                     /*fixed width, according to the figma design* */
    <div className="flex w-[1164px] justify-between items-center px-6 py-3 border-b bg-white shadow-sm">
     <SearchContainer/>
