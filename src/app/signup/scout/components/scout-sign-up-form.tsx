// src/app/signup/scout/components/scout-sign-up-form.tsx
'use client';
        ...
        <div className="flex flex-col gap-8 w-full py-8">
            ...
            <div className="space-y-6">
                <div className="space-y-2">
                    ...
                    <p className="text-[#1B1B1B]/70">Uncover the next football superstar.</p>
                </div>
            ...
            <form className="space-y-6">
                ...
                <div className="space-y-2">
                    <label className="text-base font-semibold text-[#1B1B1B]">License Number:</label>
                    <Input placeholder="Enter your license number" className="h-11"/>
                </div>
                <div className="space-y-2">
